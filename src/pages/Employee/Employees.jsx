...
function ActionButtons({ id, navigate, handleDelete }) {
  return (
    <div className="flex justify-center gap-3">
      ...
      <button
        ...
        className="w-8 h-8 rounded-full bg-yellow-500 text-white flex items-center justify-center hover:scale-110 transition"
        title="Edit"
      >
        <FaEdit size={13} />
      </button>
